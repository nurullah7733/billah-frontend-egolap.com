...
const Error = () => {
  return (
    <>
      <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white dark:bg-gray-600">
        <div className="text-center">
          ...
          <p className="text-slate-600 mt-5 lg:text-lg dark:!text-white">
